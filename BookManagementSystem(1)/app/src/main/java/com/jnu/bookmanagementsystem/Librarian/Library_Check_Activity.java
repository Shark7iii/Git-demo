...
import com.jnu.bookmanagementsystem.DeleteDetailActivity;
...
public class Library_Check_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private void setLVClickListener() {
        searchLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                //创建意图对象
                Intent intent = new Intent(Library_Check_Activity.this, DeleteDetailActivity.class);
                //设置传递键值对
        ...
        searchLv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                BookBean currentBean = bookList.get(i);
                //创建意图对象
                Intent intent = new Intent(Library_Check_Activity.this, Edit_Activity.class);
                //设置传递键值对
                intent.putExtra("currentBeanId", currentBean.getId());
                //激活意图,跳转界面
                startActivity(intent);
